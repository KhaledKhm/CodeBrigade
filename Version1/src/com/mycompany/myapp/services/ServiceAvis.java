...
public class ServiceAvis { 
 ...
 public ArrayList<Avis> Aviss;
  ...
  public boolean DeleteAvis(int id) {
        String url = Statics.BASE_URL + "/deleteAvisJASON/"+id ; //création de l'URL
    ...
    public ArrayList<Avis> parseAviss(String jsonText){
        try {
            ...
            */
            Map<String,Object> AvissListJson = j.parseJSON(new CharArrayReader(jsonText.toCharArray()));
            ...
            */
            List<Map<String,Object>> list = (List<Map<String,Object>>)AvissListJson.get("root");
            ...
            for(Map<String,Object> obj : list){
                ...
                t.setId((int)id);
                t.setEtoiles(((int)Float.parseFloat(obj.get("Etoiles").toString())));
    ...
    public ArrayList<Avis> getAllAviss(){
        String url = Statics.BASE_URL+"/GetAvisJASON";
        req.setUrl(url);
        req.setPost(false);
        req.addResponseListener(new ActionListener<NetworkEvent>() {
            @Override
