...
public class KitchenSink  {
    ...
    private void showSplashAnimation() {
        ...
        ScaleImageLabel iconBackground = new ScaleImageLabel(res.getImage("logo.png"));
        ...
        Label iconForeground = new Label(res.getImage("logo.png"));
        ...
        callSerially(() -> {
            ...
            Label kitchenSink = new Label("Code Brigade", "SplashTitle");
            kitchenSink.setWidth(12); 
            ...
            callSerially(() -> {
                ...
                Label byCodenameOne = new Label("by Houssem Ouerdiane", "SplashSubTitle");
    ...
    public void start() {
        if(getAppstoreURL() != null) {
            RatingWidget.bindRatingListener(180000, getAppstoreURL(), "houssem.ouerdiane@esprit.tn");
        }
    ...
    public void showMainUI() {
        ...
        final Form f = new Form("Code Brigade", new BorderLayout());
        res = UIManager.initFirstTheme("/theme");
        f.getStyle().setBgImage(res.getImage("background.jpg"));
        ...
        Object bottomMask = bottom.createMask();
        for (int iter = 0; iter < colorBottoms.length; iter++) {
            colors[iter] = f.getUIManager().getComponentStyle("Blank" + (iter + 1)).getBgColor();
            colorBottoms[iter] = Image.createImage(bottom.getWidth(), bottom.getHeight(), 0xff000000 | colors[iter]);
            colorBottoms[iter] = colorBottoms[iter].applyMask(bottomMask);
        }
        Demo[] demos = new Demo[] {
            ...
            new ClockDemo(),
            new Themes(), 
            new ListEvaluationsForm() ,
            new AddEvaluation() ,
            new ListEntretiensForm(),
            new AddEntretien() , 
            new teest(),
        ...
        Label name = new Label("Houssem");
        name.setUIID("Houssem");
        ...
        f.getToolbar().addMaterialCommandToSideMenu("About", 
                FontImage.MATERIAL_INFO, e -> {
                    Dialog.show("About", "Code Brigade is a Work management App "
