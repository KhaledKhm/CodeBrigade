 ...
 */
final class Version20210330192902 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE cv ADD idutli INT NOT NULL');
        $this->addSql('ALTER TABLE formation ADD idutli INT NOT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE cv DROP idutli');
        $this->addSql('ALTER TABLE formation DROP idutli');
    }
}
