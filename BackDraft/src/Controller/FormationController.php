...
class FormationController extends AbstractController
{
     ...
     */
    public function fajouterFormation(\Swift_Mailer $mailer)
    {
        ...
        if(isset($_POST['libelle']) and isset($_POST['description']) and isset($_POST['nbrParticipant']) and isset($_POST['datedebut']) and isset($_POST['datefin']) )
        {
            ...
            $message = (new \Swift_Message('Formation Ajoutee'))
                ...
                ->setBody('Bonjour Wissem ,Merci pour choisir JobBook ,Votre Formation a ete ajoutee'
                );
     ...
     */
    public function fafficheformation()
    {
        $listFormation=$this->getDoctrine()
            ->getRepository(Formation::class)
            ->findAll();

        return $this->render('front/afficheFormation.html.twig', array('listFormation'=>$listFormation)
     ...
     */
    public function ajouterFormation( \Swift_Mailer $mailer)
    {
     ...
     */
    public function deleteFormation($id,FlashyNotifier $flashy, \Swift_Mailer $mailer)
    {
        $em=$this->getDoctrine()->getManager();
     ...
     */
    public function updateFormation($id, \Swift_Mailer $mailer)
    {   $em = $this->getDoctrine()->getManager();
        $formation = $em->getRepository(Formation::class)->find($id);
        ...
        if(isset($_POST['libelle']) and isset($_POST['description']) and isset($_POST['nbrParticipant']) and isset($_POST['datedebut']) and isset($_POST['datefin']) )
        {
            ...
            $message = (new \Swift_Message('Formation Modifiee'))
                ->setFrom('noreplyjobbookmail@gmail.com')
                ->setTo('wissem.lahbib@esprit.tn')
                ->setBody('Bonjour Wissem ,Merci pour choisir JobBook ,Votre Formation a ete modifiee'
                );
     ...
     */
    public function fupdateFormation($id, \Swift_Mailer $mailer)
    {   $em = $this->getDoctrine()->getManager();
        $formation = $em->getRepository(Formation::class)->find($id);
